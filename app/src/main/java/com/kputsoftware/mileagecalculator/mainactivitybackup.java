    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaffiliate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                Intent i = new Intent(mainactivitybackup.this, Affiliate_listview.class);
                startActivity(i);
            }});
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (etravelkilometer.length() >0){
                    travelkilometer = df.format(travelkilometer());
                }else
                {
            ...
            //    db.saveinfo(date,currency,fuelprice,travelkilometer,fuelused,mileage,totalprice);
...
//        db.updateadsenable(adsenable);
     ...
     //   displaynote();
        ...
        if (getSharedPreferences(MC,0).getInt(CALCOUNT,0) < 2){
            if (getSharedPreferences(MC,0).getInt(FIRSTOPEN,1) == 0) {
                displaynote();
                //  db.updatefirstopen(1);
    ...
    class updatedb extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(adsenable.equals("yes")) {
                //       db.updateadsenable(adsenable);
                sharedpref.edit().putString(ADS,adsenable).commit();
                AdView adview = (AdView) findViewById(R.id.adview);
                AdRequest adRequest = new AdRequest.Builder().build();
                if(!BuildConfig.DEBUG && !currency.equals("RSOP")) {
            ...
            if(country.equals("in") && !getSharedPreferences(MC,0).getString(AFFILIATEURL,"empty").equals("empty"))
            {
                btnaffiliate.setVisibility(View.VISIBLE);
            }
        }
    }
    ...
    private float fuelprice() {
        float  value = Float.valueOf(efuelprice.getText().toString());
        return value;
    }
    private float travelkilometer(){
        float  value = Float.valueOf(etravelkilometer.getText().toString());
        if (lengthmetric == 1){
    ...
    private float fuelused(){
        float  value = Float.valueOf(efuelused.getText().toString());
        return value;
    }
    private float mileage(){
        float  value = Float.valueOf(emileage.getText().toString());
        return value;
    }
    private float totalprice(){
        float  value = Float.valueOf(etotalprice.getText().toString());
        return value;
    }
    ...
    private void ctravelkilometer(){
        ...
        fc().setText("Total Kilometer = " + String.format ("%.2f", travelkilometer) + " KM");
    ...
    private void cfuelused(){
        ...
        fc().setText(" Fuel Used = " + String.format ("%.2f", fuelused) + " Ltr");
    ...
    private void cmileage() {
        ...
        fc().setText(" Mileage = " + String.format ("%.2f", mileage) + " KM/L");
    ...
    private void perkm() {
        ...
        tvalue3.setText("1 km = " + String.format ("%.2f", perkm)+ " " + currency);
    ...
    public void onBackPressed() {
        ...
        if ( calcount > 10) {
            if(getSharedPreferences(MC,0).getInt("SHARED",0)<3) {
                ...
                Toast.makeText(mainactivitybackup.this, " Please click Back again to exit", Toast.LENGTH_SHORT).show();
            }
    ...
    private void opensharescreen() {
        ...
        getSharedPreferences(MC,0).edit().putInt("SHARED",share + 1).commit();

        android.app.AlertDialog.Builder alertDialog2 = new android.app.AlertDialog.Builder(mainactivitybackup.this);
    ...
    private class loadadd extends AsyncTask<String, String, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equals("yes")) {
                ...
                getSharedPreferences(MC, 0).edit().putString("productlink", productlink).commit();
